...
public class CATA80CookerPowerData extends BaseCookerPowerData {

    private static int TOTAL_POWER = 7200;
    ...
    private static final int[] COOKER_D_POWER_TABLE = {0,50,100,150,200,250,350,600,1000,1200,1500,1200,1200};
    ...
    protected int getCookerType() {
        return CookerConstant.COOKER_TYPE_CATA_80;
    }
