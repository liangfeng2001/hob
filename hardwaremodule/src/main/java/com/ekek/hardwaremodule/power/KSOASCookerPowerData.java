...
public class KSOASCookerPowerData extends BaseCookerPowerData {
    private static final int TOTAL_POWER = 7200;
    ...
    private static final int[] COOKER_C_POWER_TABLE = {0,100,150,200,250,350,600,1000,1300,1500,2000,1500,1500};
    private static final int[] COOKER_D_POWER_TABLE = {0,100,150,200,250,350,600,1000,1500,2000,2800,2000,2000};
