...
public class UpdateSettingFragment extends BaseFragment {
    ...
    TextView tvTitle;
    @BindView(R2.id.title_update_avaliable)
    TextView titleUpdateAvaliable;
    Unbinder unbinder;
    private Typeface typeface;
    @Override
    public int initLyaout() {
        return R.layout.settingmodule_fragment_update_setting;
    }
    ...
    private void SetFont() {
        ...
        titleUpdateAvaliable.setTypeface(typeface);
    }
