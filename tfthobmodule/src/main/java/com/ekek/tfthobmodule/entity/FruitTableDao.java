...
/** 
 * DAO for table "FRUIT_TABLE".
*/
public class FruitTableDao extends AbstractDao<FruitTable, Long> {

    public static final String TABLENAME = "FRUIT_TABLE";

    /**
     * Properties of entity FruitTable.<br/>
    ...
    public FruitTableDao(DaoConfig config) {
        super(config);
    }
    
    public FruitTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRUIT_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FRUIT_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FruitTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FruitTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public FruitTable readEntity(Cursor cursor, int offset) {
        FruitTable entity = new FruitTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, FruitTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(FruitTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FruitTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(FruitTable entity) {
