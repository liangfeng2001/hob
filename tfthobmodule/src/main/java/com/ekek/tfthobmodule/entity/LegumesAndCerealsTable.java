...
@Entity
public class LegumesAndCerealsTable {
    ...
    @Generated(hash = 805633910)
    public LegumesAndCerealsTable(Long id, String name, String weight,
            List<String> cookDatas) {
        this.id = id;
        this.name = name;
        this.weight = weight;
        this.cookDatas = cookDatas;
    }
    @Generated(hash = 1206402914)
    public LegumesAndCerealsTable() {
    }
    public Long getId() {
        return this.id;
    }
