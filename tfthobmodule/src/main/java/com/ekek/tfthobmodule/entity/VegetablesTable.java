...
public class VegetablesTable {
    ...
    @Generated(hash = 771940025)
    public VegetablesTable(Long id, String name, String weight,
    ...
    @Generated(hash = 1877476694)
    public VegetablesTable() {
    }
    public Long getId() {
        return this.id;
    }
