...
public class Hob60BigCircleCooker extends BaseCircleCookerView implements HobCircleCookerContract{
    /************need config here for every hob type*************/
    private static final int HOB_CIRCLE_COOKER_SIZE_WIDTH = 419 + 50;//480
    private static final int HOB_CIRCLE_COOKER_SIZE_HEIGHT = 419 + 100;//500
    private static final int POWER_OFF_BG_BITMAP_ID = R.mipmap.bg_hob_60_big_circle_cooker_poweroff;
    private static final int POWER_ON_WITHOUT_PAN_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_poweron_without_pan;
    ...
    private static final int POWER_ON_FIRE_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_poweron_fire_gear_without_timer;
    ...
    private static final int POWER_ON_FIRE_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_poweron_fire_gear_with_timer;
    ...
    private static final int HIGH_TEMP_BG_BITMAP_ID = R.mipmap.bg_hob_60_big_circle_cooker_high_temp;

    private static final int ERROR_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_error;
    private static final int ERROR_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_error_haier;

    private static final int POWER_ON_TEMP_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_poweron_temp_gear_word_without_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_poweron_temp_gear_word_with_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_poweron_temp_gear_picture_without_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_poweron_temp_gear_picture_with_timer;
    ...
    private static final int TEMP_PREPARE_SENSOR_BG_BITMAP_ID = R.mipmap.bg_hob_60_big_circle_cooker_temp_mode_preheat;
    ...
    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_ready_to_cook;
    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_circle_cooker_ready_to_cook_haier;

    private static final int TEMP_SENSOR_READY_VALUE_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_ready_to_cook_value;

    private static final int TEMP_WORK_FINISH_LIGHT_BG_BITMAP_ID = R.mipmap.bg_big_cooker_add_10_minutes_tips_light;
    ...
    private static final int TEMP_WORK_RECIPES_BG_BITMAP_ID = R.mipmap.bg_hob_60_big_cooker_recipes_temp_mode;


    private static final int FONT_SIZE_FOR_FIRE_GEAR_WITHOUT_TIMER = 165; // 160  火力 不带 时间显示
    private static final int FONT_SIZE_FOR_FIRE_GEAR_WITH_TIMER = 165; // 150
    private static final int FONT_SIZE_FOR_TIMER = 100; //100
    private static final int FONT_SIZE_FOR_TIMER_SMALL = 72;  // 时间
    private static final int FONT_SIZE_FOR_TIMER_WITH_INDICATOR = 100;
    private static final int FONT_SIZE_FOR_TIMER_WITH_INDICATOR_SMALL = 72;
    private static final int FONT_SIZE_FOR_ERROR = 200;
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITHOUT_TIMER_BIG = 140;//两位数  不带时间显示  170
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITHOUT_TIMER_SMALL = 110;//三位数  110
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITH_TIMER_BIG = 140;//两位数   带时间显示 110
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITH_TIMER_SMALL = 110;//三位数  95
    private static final int FONT_SIZE_FOR_KEEP_WARM_AND_ADD_TEN_MINUTE = 80;//60
    private static final int FONT_SZIE_FOR_READY_TO_COOK = 52;
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_BIG = 140;//预热阶段
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_SMALL = 110;//预热阶段 110
    private static final int FONT_SIZE_TEMP_PREHEAT_REAL_TEMP_VALUE = 53;//预热阶段
    ...
    private static final int REAL_TEMP_PROGRESS_RADIUS = 78;//真实温度圆环半径
    ...
    public Hob60BigCircleCooker(Context context) {
        this(context, null);
    }

    public Hob60BigCircleCooker(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected Bitmap getRecipesPicBitmap() {
        ...
        if (recipesPicBp == null) {
            ...
            recipesPicBp = ImageUtil.decodeBitmapForScale(getContext(), RecipesUtil.getRecipesImageForCircleCooker(recipesID),1.2f);
        }
        return recipesPicBp;
    }
