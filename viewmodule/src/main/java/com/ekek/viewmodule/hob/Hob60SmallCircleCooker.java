...
public class Hob60SmallCircleCooker extends BaseCircleCookerView implements HobCircleCookerContract {
    ...
    private static final int POWER_OFF_BG_BITMAP_ID = R.mipmap.bg_hob_60_small_circle_cooker_poweroff;
    private static final int POWER_ON_WITHOUT_PAN_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_poweron_without_pan;
    ...
    private static final int POWER_ON_FIRE_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_poweron_fire_gear_without_timer;
    ...
    private static final int POWER_ON_FIRE_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_poweron_fire_gear_with_timer;
    ...
    private static final int HIGH_TEMP_BG_BITMAP_ID = R.mipmap.bg_hob_60_small_circle_cooker_high_temp;

    private static final int ERROR_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_error;
    private static final int ERROR_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_small_circle_cooker_error_haier;

    private static final int POWER_ON_TEMP_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_poweron_temp_gear_word_without_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_60_small_circle_cooker_poweron_temp_gear_word_with_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_poweron_temp_gear_picture_without_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_poweron_temp_gear_picture_with_timer;
    ...
    private static final int TEMP_PREPARE_SENSOR_BG_BITMAP_ID = R.mipmap.bg_hob_60_small_circle_cooker_temp_mode_preheat;
    ...
    private static final int TEMP_INDICATOR_PREPARE_SENSOR_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_user_prepare_with_picture;
    ...
    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_ready_to_cook;
    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_small_circle_cooker_ready_to_cook_haier;

    private static final int TEMP_SENSOR_READY_VALUE_BG_BITMAP_ID = R.mipmap.bg_small_circle_cooker_ready_to_cook_value;

    private static final int TEMP_WORK_FINISH_LIGHT_BG_BITMAP_ID = R.mipmap.bg_small_cooker_add_10_minutes_tips_light;
    ...
    private static final int TEMP_WORK_RECIPES_BG_BITMAP_ID = R.mipmap.bg_hob_60_small_cooker_recipes_temp_mode;

    private static final int FONT_SIZE_FOR_FIRE_GEAR_WITHOUT_TIMER = 110;  // 110
    private static final int FONT_SIZE_FOR_FIRE_GEAR_WITH_TIMER = 110; // 100
    private static final int FONT_SIZE_FOR_TIMER = 60;  // 时间
    private static final int FONT_SIZE_FOR_TIMER_SMALL = 45;  // 时间
    private static final int FONT_SIZE_FOR_TIMER_WITH_INDICATOR = 60;
    ...
    private static final int FONT_SIZE_FOR_KEEP_WARM_AND_ADD_TEN_MINUTE = 60;//40
    private static final int FONT_SZIE_FOR_READY_TO_COOK = 32;
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_BIG = 72;//预热阶段
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_SMALL = 65;//预热阶段 62
    ...
    private static final int REAL_TEMP_PROGRESS_RADIUS = 50;//真实温度圆环半径
    ...
    public Hob60SmallCircleCooker(Context context) {
        super(context);
    }

    public Hob60SmallCircleCooker(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
