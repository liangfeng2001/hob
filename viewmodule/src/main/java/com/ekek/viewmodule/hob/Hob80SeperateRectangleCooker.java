...
public class Hob80SeperateRectangleCooker extends BaseSeperateRectangleCookerView implements HobCircleCookerContract{
    /************need config here for every hob type*************/
    private static final int HOB_CIRCLE_COOKER_SIZE_WIDTH = 266 + 70;//266
    private static final int HOB_CIRCLE_COOKER_SIZE_HEIGHT = 266 + 0;//261
    private static final int POWER_OFF_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_power_off;
    private static final int POWER_ON_WITHOUT_PAN_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_no_pan;
    private static final int POWER_ON_WITHOUT_PAN_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_poweron_without_pan_haier;
    private static final int POWER_OFF_BUTTON_BITMAP_ID = R.mipmap.ic_hob_60_cooker_poweroff;//R.mipmap.ic_hob_80_power_off_button
    private static final int POWER_ON_FIRE_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_fire_gear_without_timer;
    private static final int POWER_ON_FIRE_GEAR_WITHOUT_TIMER_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_circle_cooker_poweron_fire_gear_without_timer_haier;

    private static final int POWER_ON_FIRE_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_power_on_fire_with_timer;
    private static final int POWER_ON_FIRE_GEAR_WITH_TIMER_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_circle_cooker_poweron_fire_gear_with_timer_haier;

    private static final int HIGH_TEMP_BG_BITMAP_ID = R.mipmap.bg_hob_80_seperate_high_temp;

    private static final int ERROR_BG_BITMAP_ID = R.mipmap.bg_hob_80_seperate_cooker_error_occur;
    private static final int ERROR_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_error_haier;

    private static final int POWER_ON_TEMP_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_power_on_temp_without_timer;
    private static final int POWER_ON_TEMP_GEAR_WITHOUT_TIMER_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_poweron_temp_gear_word_without_timer_haier;

    private static final int POWER_ON_TEMP_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_power_on_temp_with_timer;
    private static final int POWER_ON_TEMP_GEAR_WITH_TIMER_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_poweron_temp_gear_word_with_timer_haier;

    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_power_on_temp_indicator_without_timer;
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITHOUT_TIMER_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_circle_cooker_poweron_temp_gear_picture_without_timer_haier;

    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_power_on_temp_indicator_with_timer;
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITH_TIMER_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_poweron_temp_gear_picture_with_timer_haier;

    private static final int TEMP_PREPARE_SENSOR_BG_BITMAP_ID = R.mipmap.bg_hob_80_seperate_prepare_temp_sensor;
    private static final int TEMP_PREPARE_SENSOR_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_user_prepare_haier;

    private static final int TEMP_INDICATOR_PREPARE_SENSOR_BG_BITMAP_ID = R.mipmap.bg_big_circle_cooker_user_prepare_with_picture;
    private static final int TEMP_INDICATOR_PREPARE_SENSOR_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_circle_cooker_user_prepare_with_picture_haier;

    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID = R.mipmap.bg_hob_80_seperate_ready_to_cook;
    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_circle_cooker_ready_to_cook_haier;

    private static final int TEMP_SENSOR_READY_VALUE_BG_BITMAP_ID = R.mipmap.bg_hob_80_seperate_ready_to_cook_value;

    private static final int TEMP_WORK_FINISH_LIGHT_BG_BITMAP_ID = R.mipmap.bg_hob_80_seperate_keep_warm_light;
    private static final int TEMP_WORK_FINISH_LIGHT_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_cooker_keep_warm_tips_light_haier;

    private static final int TEMP_WORK_FINISH_DARK_BG_BITMAP_ID = R.mipmap.bg_hob_60_big_cooker_keep_warm_tips_dark;
    private static final int TEMP_WORK_FINISH_DARK_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_cooker_keep_warm_tips_dark_haier;

   // private static final int TEMP_WORK_RECIPES_BG_BITMAP_ID = R.mipmap.bg_hob_80_seperate_cooker_recipes;
   private static final int TEMP_WORK_RECIPES_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_seperate_cooker_power_off;


    private static final int FONT_SIZE_FOR_FIRE_GEAR_WITHOUT_TIMER = 108; // 160  火力 不带 时间显示
    private static final int FONT_SIZE_FOR_FIRE_GEAR_WITH_TIMER = 108; // 150
    private static final int FONT_SIZE_FOR_TIMER = 60; //100
    private static final int FONT_SIZE_FOR_TIMER_WITH_INDICATOR = 90;
    private static final int FONT_SIZE_FOR_ERROR = 180;
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITHOUT_TIMER_BIG = 92;//两位数  不带时间显示  170
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITHOUT_TIMER_SMALL = 72;//三位数  120
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITH_TIMER_BIG = 92;//两位数   带时间显示 130
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITH_TIMER_SMALL = 72;//三位数  95
    private static final int FONT_SIZE_FOR_KEEP_WARM_AND_ADD_TEN_MINUTE = 56;
    private static final int FONT_SZIE_FOR_READY_TO_COOK = 36;
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_BIG = 92;//预热阶段
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_SMALL = 72;//预热阶段
    private static final int FONT_SIZE_TEMP_PREHEAT_REAL_TEMP_VALUE = 36;//预热阶段
    private static final int FONT_SZIE_FOR_TEMP_INDICATOR = 32;
    ...
    private int fireGearValue = 5,tempGearValue = 85;
    private int realTempValue = 60;
    ...
    public Hob80SeperateRectangleCooker(Context context) {
        this(context, null);
    }

    public Hob80SeperateRectangleCooker(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected Bitmap getTempIndicatorBitmap() {
        /*if (tempIndicatorBp == null) {
            tempIndicatorBp = BitmapFactory.decodeResource(getResources(), TEMP_GEAR_INDICATOR_BG_BITMAP_ID);
        }
        return tempIndicatorBp;*/

        if (tempIndicatorBp == null) {
                //tempIndicatorBp = ImageUtil.decodeTempIdentifyBitmap(getContext(), TEMP_GEAR_INDICATOR_BG_BITMAP_ID,getTempGearIndicatorWithoutTimerBitmap().getWidth(),getTempGearIndicatorWithoutTimerBitmap().getHeight() / 2);
            tempIndicatorBp = ImageUtil.decodeTempIdentifyBitmap(getContext(), tempIndicatorID,getTempGearIndicatorWithoutTimerBitmap().getWidth(),getTempGearIndicatorWithoutTimerBitmap().getHeight() / 2,0.6f);
    ...
    protected Bitmap getTempIndicatorBitmapWithTimer() {
        if (tempIndicatorBp == null) {
            //tempIndicatorBp = ImageUtil.decodeTempIdentifyBitmap(getContext(), TEMP_GEAR_INDICATOR_BG_BITMAP_ID,getTempGearIndicatorWithoutTimerBitmap().getWidth(),getTempGearIndicatorWithoutTimerBitmap().getHeight() / 2);
            tempIndicatorBp = ImageUtil.decodeTempIdentifyBitmap(getContext(), tempIndicatorID,getTempGearIndicatorWithoutTimerBitmap().getWidth(), (int) (getTempGearIndicatorWithoutTimerBitmap().getHeight() * 1));
    ...
    protected Bitmap getRecipesPicBitmap() {
        ...
        if (recipesPicBp == null) {
            ...
            //recipesPicBp = BitmapFactory.decodeResource(getResources(), R.mipmap.food_recipe_tostada_for_circle_cooker);
            LogUtil.d("recipesID---->" + recipesID);
            recipesPicBp = ImageUtil.decodeBitmapForScale(getContext(), RecipesUtil.getRecipesImageForSeperateRetangleCooker(recipesID),1.04f);//1.05
        }
        return recipesPicBp;
    }
    ...
    protected Bitmap getRecipesBgBitmap() {
        if (recipesBgBp == null) {
            if (RecipesUtil.getRecipesImageForSeperateRetangleCooker(recipesID) == R.mipmap.food_recipe_customize_default_image) {
    ...
    protected String getRealTempValue() {
        LogUtil.d("Enter:: getRealTempValue---->" + realTempValue);
...
//        LogUtil.d("Enter:: cirecle updateUI------->" + workMode);
  //      LogUtil.d("Enter:: tempValue------->" + tempValue);
   //     LogUtil.d("Enter:: fireValue------->" + tempValue);
        //invalidate();
    }
    ...
    public void setCookerPosition(int position) {
        this.cookerPosition = position;
    }
