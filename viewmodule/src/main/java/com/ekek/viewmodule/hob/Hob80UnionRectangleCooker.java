...
public class Hob80UnionRectangleCooker extends BaseUnionRectangleCookerView implements HobCircleCookerContract{
    /************need config here for every hob type*************/
    private static final int HOB_CIRCLE_COOKER_SIZE_WIDTH = 262 + 70;//262
    private static final int HOB_CIRCLE_COOKER_SIZE_HEIGHT = 555 + 0;//
    private static final int POWER_OFF_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_power_off;
    private static final int POWER_ON_WITHOUT_PAN_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_no_pan;
    ...
    private static final int POWER_ON_FIRE_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_power_on_fire_without_timer;
    ...
    private static final int POWER_ON_FIRE_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_power_on_fire_with_timer;
    ...
    private static final int HIGH_TEMP_BG_BITMAP_ID = R.mipmap.bg_hob_80_union_high_temp;

    private static final int ERROR_BG_BITMAP_ID = R.mipmap.bg_hob_80_union_cooker_error_occur;
    private static final int ERROR_BG_BITMAP_ID_haier= R.mipmap.bg_hob_60_big_circle_cooker_error_haier;
//
    private static final int POWER_ON_TEMP_GEAR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_power_on_temp_without_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_power_on_temp_with_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_power_on_temp_indicator_without_timer;
    ...
    private static final int POWER_ON_TEMP_GEAR_INDICATOR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_80_rectangle_union_cooker_power_on_temp_indicator_with_timer;
    ...
    private static final int TEMP_PREPARE_SENSOR_BG_BITMAP_ID = R.mipmap.bg_hob_80_union_prepare_temp_sensor;
    ...
    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID = R.mipmap.bg_hob_80_union_ready_to_cook;
    private static final int TEMP_SENSOR_READY_BG_BITMAP_ID_haier = R.mipmap.bg_hob_60_big_circle_cooker_ready_to_cook_haier;

    private static final int TEMP_SENSOR_READY_VALUE_BG_BITMAP_ID = R.mipmap.bg_hob_80_union_ready_to_cook_value;

    private static final int TEMP_WORK_FINISH_LIGHT_BG_BITMAP_ID = R.mipmap.bg_hob_80_union_keep_warm_light;
    ...
    private static final int TEMP_WORK_RECIPES_BG_BITMAP_ID = R.mipmap.bg_hob_80_union_cooker_recipes;
    ...
    private static final int FONT_SIZE_FOR_ERROR = 200;
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITHOUT_TIMER_BIG = 108;//两位数  不带时间显示  170
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITHOUT_TIMER_SMALL = 85;//三位数  120
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITH_TIMER_BIG = 108;//两位数   带时间显示 130
    private static final int FONT_SIZE_FOR_TEMP_GEAR_WITH_TIMER_SMALL = 85;//三位数  95
    private static final int FONT_SIZE_FOR_KEEP_WARM_AND_ADD_TEN_MINUTE = 62;//52
    private static final int FONT_SZIE_FOR_READY_TO_COOK = 36;
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_BIG = 108;//预热阶段
    private static final int FONT_SIZE_TEMP_PREHEAT_SETTING_TEMP_VALUE_SMALL = 85;//预热阶段
    private static final int FONT_SIZE_TEMP_PREHEAT_REAL_TEMP_VALUE = 44;//预热阶段
    ...
    public Hob80UnionRectangleCooker(Context context) {
        this(context, null);
    }

    public Hob80UnionRectangleCooker(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected Bitmap getTempIndicatorBitmap() {
        ...
        if (tempIndicatorBp == null) {
            ...
            tempIndicatorBp = ImageUtil.decodeTempIdentifyBitmap(getContext(), tempIndicatorID,getTempGearIndicatorWithoutTimerBitmap().getWidth(),getTempGearIndicatorWithoutTimerBitmap().getHeight() / 2);
    ...
    protected Bitmap getRecipesPicBitmap() {
        ...
        if (recipesPicBp == null) {
            ...
            recipesPicBp = ImageUtil.decodeBitmapForScale(getContext(), RecipesUtil.getRecipesImageForUnionRetangleCooker(recipesID),1.045f);//1.0
        }
        return recipesPicBp;
    }
    ...
    protected Bitmap getRecipesBgBitmap() {
        if (recipesBgBp == null) {
            if (RecipesUtil.getRecipesImageForUnionRetangleCooker(recipesID) == R.mipmap.food_recipe_customize_default_image) {
