...
public class Hob90RectangleCooker extends BaseRectangleCookerView implements HobRectangleCookerContract {
    /************need config here for every hob type*************/
    private static final int HOB_RETANGLE_COOKER_SIZE_WIDTH = 248 + 80;//480
    private static final int HOB_RETANGLE_COOKER_SIZE_HEIGHT = 518 + 50;//500
    private static final int POWER_OFF_UNION_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_union_cooker_power_off;
    private static final int POWER_OFF_SEPERATE_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_seperate_cooker_power_off;
    private static final int POWER_ON_SEPERATE_FIRE_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_seperate_cooker_fire_gear_without_timer;
    private static final int POWER_ON_SEPERATE_FIRE_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_seperate_cooker_power_on_fire_with_timer;
    private static final int POWER_OFF_BUTTON_BITMAP_ID = R.mipmap.ic_hob_90_power_off_button;
    ...
    private static final int POWER_ON_UNION_TEMP_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_union_cooker_power_on_temp_without_timer;
    private static final int POWER_ON_UNION_TEMP_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_union_cooker_power_on_temp_with_timer;
    ...
    private static final int POWER_ON_UNION_ABNORMAL_NO_PAN = R.mipmap.bg_hob_90_rectangle_union_cooker_no_pan;
    private static final int POWER_ON_SEPERATE_ABNORMAL_NO_PAN = R.mipmap.bg_hob_90_rectangle_seperate_cooker_no_pan;
    private static final int POWER_ON_UNION_TEMP_INDICATOR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_union_cooker_power_on_temp_indicator_without_timer;
    private static final int POWER_ON_UNION_TEMP_INDICATOR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_union_cooker_power_on_temp_indicator_with_timer;
    private static final int POWER_ON_SEPERATE_TEMP_INDICATOR_WITHOUT_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_seperate_cooker_power_on_temp_indicator_without_timer;
    private static final int POWER_ON_SEPERATE_TEMP_INDICATOR_WITH_TIMER_BG_BITMAP_ID = R.mipmap.bg_hob_90_rectangle_seperate_cooker_power_on_temp_indicator_with_timer;
    ...
    private static final int SEPERATE_TEMP_FINISH_LIGHT_BG_BITMAP_ID = R.mipmap.bg_hob_90_seperate_keep_warm_light;
    private static final int SEPERATE_TEMP_FINISH_DARK_BG_BITMAP_ID = R.mipmap.bg_hob_90_seperate_keep_warm_dark;
    private static final int UNION_READY_TO_COOK_BG_BITMAP_ID = R.mipmap.bg_hob_90_union_ready_to_cook;
    private static final int SEPERATE_READY_TO_COOK_BG_BITMAP_ID = R.mipmap.bg_hob_90_seperate_ready_to_cook;
    private static final int UNION_PREPARE_TEMP_SENSOR_BG_BITMAP_ID = R.mipmap.bg_hob_90_union_prepare_temp_sensor;
    ...
    private static final int SEPERATE_PREPARE_TEMP_SENSOR_BG_BITMAP_ID = R.mipmap.bg_hob_90_seperate_prepare_temp_sensor;
    ...
    private static final int UNION_ERROR_OCCUR_BG_BITMAP_ID = R.mipmap.bg_hob_90_union_cooker_error_occur;
    private static final int SEPERATE_ERROR_OCCUR_BG_BITMAP_ID = R.mipmap.bg_hob_90_seperate_cooker_error_occur;
    ...
    private static final int FONT_SIZE_FOR_UNION_TEMP_GEAR_WITHOUT_TIMER_BIG = 100;
    ...
    private static final int FONT_SIZE_FOR_SEPERATE_TEMP_GEAR_WITHOUT_TIMER_TEMP_SIZE_BIG = 80;
    ...
    private int unionTempGearValue = 160;
    ...
    private int upTempGearValue = 60;
    ...
    public Hob90RectangleCooker(Context context) {
        super(context);
    }

    public Hob90RectangleCooker(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
