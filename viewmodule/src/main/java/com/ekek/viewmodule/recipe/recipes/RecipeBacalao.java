...
public class RecipeBacalao extends BaseRecipe {

    @Override
    protected int getNameResource() {
        return R.string.viewmodule_food_recipe_bacalao;
    }

    @Override
    protected int getTitleResource() {
        return R.string.viewmodule_recipe_bacalao_title;
    }

    @Override
    protected int getImageResource() {
        return R.mipmap.food_recipe_bacalao;
    }
    ...
    protected void initAttributes() {
        ...
        attributes.add(new RecipeAttribute(
                ...
                R.string.viewmodule_recipe_bacalao_difficulty,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_cooking_time,
                R.string.viewmodule_recipe_bacalao_cooking_time,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_type,
                R.string.viewmodule_recipe_bacalao_type,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_num_of_people,
                R.string.viewmodule_recipe_bacalao_num_of_people,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_allergens,
                R.string.viewmodule_recipe_bacalao_allergens,
                RecipeAttributeLen.Long));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_ingredients,
                R.string.viewmodule_recipe_bacalao_ingredients,
                RecipeAttributeLen.Long));
    }
    @Override
    protected void initSteps() {
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_bacalao_1,
                null));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_2,
                R.string.viewmodule_recipe_step_bacalao_2,
                null));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_3,
                R.string.viewmodule_recipe_step_bacalao_3,
                null));
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_bacalao_4,
                action));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_5,
                R.string.viewmodule_recipe_step_bacalao_5,
                null));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_6,
                R.string.viewmodule_recipe_step_bacalao_6,
                null));
