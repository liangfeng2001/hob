...
public class RecipeParada extends BaseRecipe {

    @Override
    protected int getNameResource() {
        return R.string.viewmodule_food_recipe_parada;
    }

    @Override
    protected int getTitleResource() {
        return R.string.viewmodule_recipe_parada_title;
    }

    @Override
    protected int getImageResource() {
        return R.mipmap.food_recipe_parada;
    }
    ...
    protected void initAttributes() {
        ...
        attributes.add(new RecipeAttribute(
                ...
                R.string.viewmodule_recipe_parada_difficulty,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_cooking_time,
                R.string.viewmodule_recipe_parada_cooking_time,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_type,
                R.string.viewmodule_recipe_parada_type,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_num_of_people,
                R.string.viewmodule_recipe_parada_num_of_people,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_allergens,
                R.string.viewmodule_recipe_parada_allergens,
                RecipeAttributeLen.Long));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_ingredients,
                R.string.viewmodule_recipe_parada_ingredients,
                RecipeAttributeLen.Long));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_what_you_need,
                R.string.viewmodule_recipe_parada_what_you_need,
                RecipeAttributeLen.Long));
    }
    @Override
    protected void initSteps() {
        ...
        group.setGroupName(R.string.viewmodule_recipe_step_group_parada_1);
        int loop = 1;
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_1_1,
                R.string.viewmodule_recipe_step_parada_1_1,
                null));
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_parada_1_2,
                action));
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_parada_1_3,
                action));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_1_4,
                R.string.viewmodule_recipe_step_parada_1_4,
                null));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_1_5,
                R.string.viewmodule_recipe_step_parada_1_5,
                null));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_1_6,
                R.string.viewmodule_recipe_step_parada_1_6,
                null));
        stepGroups.add(group);

        group = new RecipeStepGroup();
        group.setGroupName(R.string.viewmodule_recipe_step_group_parada_2);
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_2_1,
                R.string.viewmodule_recipe_step_parada_2_1,
                null));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_2_2,
                R.string.viewmodule_recipe_step_parada_2_2,
                null));
        stepGroups.add(group);
    }
}
