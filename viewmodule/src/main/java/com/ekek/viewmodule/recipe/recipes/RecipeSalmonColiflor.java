...
public class RecipeSalmonColiflor extends BaseRecipe {

    @Override
    protected int getNameResource() {
        return R.string.viewmodule_food_recipe_salmon;
    }

    @Override
    protected int getTitleResource() {
        return R.string.viewmodule_recipe_salmon_coliflor_title;
    }

    @Override
    protected int getImageResource() {
        return R.mipmap.food_recipe_salmon_coliflor;
    }
    ...
    protected void initAttributes() {
        ...
        attributes.add(new RecipeAttribute(
                ...
                R.string.viewmodule_recipe_salmon_coliflor_difficulty,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_cooking_time,
                R.string.viewmodule_recipe_salmon_coliflor_cooking_time,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_type,
                R.string.viewmodule_recipe_salmon_coliflor_type,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_num_of_people,
                R.string.viewmodule_recipe_salmon_coliflor_num_of_people,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_allergens,
                R.string.viewmodule_recipe_salmon_coliflor_allergens,
                RecipeAttributeLen.Long));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_ingredients,
                R.string.viewmodule_recipe_salmon_coliflor_ingredients,
                RecipeAttributeLen.Long));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_what_you_need,
                R.string.viewmodule_recipe_salmon_coliflor_what_you_need,
                RecipeAttributeLen.Long));
    }
    @Override
    protected void initSteps() {
        ...
        group.setGroupName(R.string.viewmodule_recipe_step_group_salmon_coliflor_1);
        int loop = 1;
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_1_1,
                R.string.viewmodule_recipe_step_salmon_coliflor_1_1,
                null));
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_salmon_coliflor_1_2,
                action));
        stepGroups.add(group);

        group = new RecipeStepGroup();
        group.setGroupName(R.string.viewmodule_recipe_step_group_salmon_coliflor_2);
        action = new RecipeStepAction(
                stepActions.size() + 1,
                loop,
                R.string.viewmodule_recipe_step_action_name_general_2_1,
                R.mipmap.recipe_step_action_start,
                85,
                0,
                45,
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_salmon_coliflor_2_1,
                action));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_2_2,
                R.string.viewmodule_recipe_step_salmon_coliflor_2_2,
                null));
        stepGroups.add(group);

        group = new RecipeStepGroup();
        group.setGroupName(R.string.viewmodule_recipe_step_group_salmon_coliflor_3);
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_3_1,
                R.string.viewmodule_recipe_step_salmon_coliflor_3_1,
                null));
        action = new RecipeStepAction(
                stepActions.size() + 1,
                loop,
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_salmon_coliflor_3_2,
                action));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_3_3,
                R.string.viewmodule_recipe_step_salmon_coliflor_3_3,
                null));
        stepGroups.add(group);

        group = new RecipeStepGroup();
        group.setGroupName(R.string.viewmodule_recipe_step_group_salmon_coliflor_4);
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_4_1,
                R.string.viewmodule_recipe_step_salmon_coliflor_4_1,
                null));
        stepGroups.add(group);
    }
}
