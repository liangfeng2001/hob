...
public class RecipeTostada extends BaseRecipe {

    @Override
    protected int getNameResource() {
        return R.string.viewmodule_food_recipe_tostada;
    }

    @Override
    protected int getTitleResource() {
        return R.string.viewmodule_recipe_tostada_title;
    }

    @Override
    protected int getImageResource() {
        return R.mipmap.food_recipe_tostada;
    }
    ...
    protected void initAttributes() {
        ...
        attributes.add(new RecipeAttribute(
                ...
                R.string.viewmodule_recipe_tostada_difficulty,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_cooking_time,
                R.string.viewmodule_recipe_tostada_cooking_time,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_type,
                R.string.viewmodule_recipe_tostada_type,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_num_of_people,
                R.string.viewmodule_recipe_tostada_num_of_people,
                RecipeAttributeLen.Short));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_allergens,
                R.string.viewmodule_recipe_tostada_allergens,
                RecipeAttributeLen.Long));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_ingredients,
                R.string.viewmodule_recipe_tostada_ingredients,
                RecipeAttributeLen.Long));
        attributes.add(new RecipeAttribute(
                R.string.viewmodule_recipe_attr_what_you_need,
                R.string.viewmodule_recipe_tostada_what_you_need,
                RecipeAttributeLen.Long));
    }
    ...
    protected void initSteps() {
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_tostada_1,
                null));
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_tostada_2,
                action));
        ...
        group.getSteps().add(new RecipeStep(
                ...
                R.string.viewmodule_recipe_step_tostada_3,
                action));
        group.getSteps().add(new RecipeStep(
                loop++,
                R.string.viewmodule_recipe_step_name_general_4,
                R.string.viewmodule_recipe_step_tostada_4,
                null));
