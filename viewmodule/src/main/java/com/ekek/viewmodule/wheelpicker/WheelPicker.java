package com.ekek.viewmodule.wheelpicker;
...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.viewmodule_WheelPicker);
        int idData = a.getResourceId(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_data, 0);
        mData = Arrays.asList(getResources()
                .getStringArray(idData == 0 ? R.array.viewmodule_WheelArrayDefault : idData));
        mItemTextSize = a.getDimensionPixelSize(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_item_text_size,
                getResources().getDimensionPixelSize(R.dimen.viewmodule_WheelItemTextSize));
        mVisibleItemCount = a.getInt(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_visible_item_count, 7);
        mSelectedItemPosition = a.getInt(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_selected_item_position, 0);
        hasSameWidth = a.getBoolean(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_same_width, false);
        mTextMaxWidthPosition =
                a.getInt(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_maximum_width_text_position, -1);
        mMaxWidthText = a.getString(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_maximum_width_text);
        mSelectedItemTextColor = a.getColor
                (R.styleable.viewmodule_WheelPicker_viewmodule_wheel_selected_item_text_color, -1);
        mItemTextColor = a.getColor(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_item_text_color, 0xFF888888);
        mItemSpace = a.getDimensionPixelSize(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_item_space,
                getResources().getDimensionPixelSize(R.dimen.viewmodule_WheelItemSpace));
        isCyclic = a.getBoolean(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_cyclic, false);
        hasIndicator = a.getBoolean(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_indicator, false);
        mIndicatorColor = a.getColor(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_indicator_color, 0xFFEE3333);
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_indicator_size,
                getResources().getDimensionPixelSize(R.dimen.viewmodule_WheelIndicatorSize));
        hasCurtain = a.getBoolean(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_curtain, false);
        mCurtainColor = a.getColor(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_curtain_color, 0x88FFFFFF);
        hasAtmospheric = a.getBoolean(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_atmospheric, false);
        isCurved = a.getBoolean(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_curved, false);
        mItemAlign = a.getInt(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_item_align, ALIGN_CENTER);
        fontPath = a.getString(R.styleable.viewmodule_WheelPicker_viewmodule_wheel_font_path);
        a.recycle();
